	...
	<section class="section-padding">
		<div class="container">
			<div class="row showcase-section">
				<div class="col-md-6">
					<img src="img5_1_02.gif" alt="showcase image">
				</div>
				<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="Screenshot_16.jpg" alt="">
										<!-- Name -->
										<h4>Ahmed A. Al-Absi</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="Screenshot_17.jpg" alt="">
										<!-- Name -->
										<h4>Sirojiddin S. Juraev</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="Screenshot_18.jpg" alt="">
										<!-- Name -->
										<h4>Md. Nur Alam</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="Screenshot_19.jpg" alt="">
										<!-- Name -->
										<h4>Nguyen Nqoc Cao</h4>
